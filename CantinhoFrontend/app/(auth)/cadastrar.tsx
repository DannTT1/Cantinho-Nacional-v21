...
export default function Cadastrar() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.inputContainer}>
        <TextInput style={styles.input} placeholder="Confirmar Senha" placeholderTextColor="#666" value={confirmarSenha} onChangeText={setConfirmarSenha} secureTextEntry />
      </View>
...
const styles = StyleSheet.create({
  ...
  inputContainer: { backgroundColor: '#1A1A1A', borderRadius: 12, marginBottom: 15, paddingHorizontal: 15, borderWidth: 1, borderColor: '#333' },
  input: { height: 55, color: '#fff' },
  regrasBox: { backgroundColor: '#1A1A1A', padding: 15, borderRadius: 12, marginBottom: 20 },
  regraTitle: { color: '#fff', fontWeight: 'bold', marginBottom: 8 },
  regraText: { fontSize: 12, marginBottom: 4 },
  ok: { color: '#2ECC71' },
  erro: { color: '#E74C3C' },
  button: { backgroundColor: Colors.primary, height: 55, borderRadius: 12, justifyContent: 'center', alignItems: 'center' },
